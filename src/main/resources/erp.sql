...
CREATE TABLE `tb_consume_record` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `consumeType` varchar(255) DEFAULT '',
  `consumeContent` varchar(255) DEFAULT '',
  `consumePrice` double(10,2) DEFAULT NULL,
  `consumeDate` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_consume_record
-- ----------------------------
