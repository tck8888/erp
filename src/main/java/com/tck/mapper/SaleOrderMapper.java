...
public interface SaleOrderMapper {
    ...
    @Select("select * from tb_sale_order where userId = #{userId}")
    @Results({
    ...
    @Update("update tb_sale_order set totalCount=#{totalCount},remark=#{remark} where id = #{id}")
    @Results({
            @Result(property = "userId", column = "userId"),
            @Result(property = "productId", column = "productId"),
            @Result(property = "warehouseId", column = "warehouseId"),
    ...
    @Insert("insert into tb_sale_order(userId,warehouseId,warehouseName," +
